...
export class PlayerRepository {
    ...
    private async triggerEvent(data: PlayerEntityEvent | PlayerUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("volleyball-matches-Teams-Player", ["trigger"]);
        ...
        producer.topic("volleyball-matches-Teams-Player").send(JSON.stringify(data));
    }
}
