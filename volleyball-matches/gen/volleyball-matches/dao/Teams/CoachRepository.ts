...
export class CoachRepository {
    ...
    private async triggerEvent(data: CoachEntityEvent | CoachUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("volleyball-matches-Teams-Coach", ["trigger"]);
        ...
        producer.topic("volleyball-matches-Teams-Coach").send(JSON.stringify(data));
    }
}
