...
export class TeamRepository {
    ...
    private async triggerEvent(data: TeamEntityEvent | TeamUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("volleyball-matches-entities-Team", ["trigger"]);
        ...
        producer.topic("volleyball-matches-entities-Team").send(JSON.stringify(data));
    }
}
