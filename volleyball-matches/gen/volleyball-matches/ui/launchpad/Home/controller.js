...
angular.module('page', ['ideUI', 'ideView', 'entityApi'])
	.config(['messageHubProvider', function (messageHubProvider) {
		messageHubProvider.eventIdPrefix = 'volleyball-matches.launchpad.Home';
	}])
	.config(['entityApiProvider', function (entityApiProvider) {
		entityApiProvider.baseUrl = '/services/js/volleyball-matches/gen/volleyball-matches/ui/launchpad/Home/tiles.js';
	}])
	.controller('PageController', ['$scope', 'messageHub', 'entityApi', '$document', function ($scope, messageHub, entityApi, $document) {
		const favoritesStoreId = 'DIRIGIBLE.volleyball-matches.favorites';
		$scope.state = {
			isBusy: true,
			error: false,
			busyText: 'Loading...',
