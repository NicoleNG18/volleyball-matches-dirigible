...
import { MatchRepository, MatchEntityOptions } from "../../dao/League/MatchRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("volleyball-matches-League-Match", ["validate"]);
...
class MatchService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/volleyball-matches/gen/volleyball-matches/api/League/MatchService.ts/" + entity.Id);
